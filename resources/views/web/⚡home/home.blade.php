    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        @foreach($this->featuredPosts as $post)
          <article class="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-500 transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-2">
            {{-- Post Image --}}
  ...
  <section class="py-20 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <a wire:navigate href="{{ route('app.posts') }}" class="px-8 py-4 text-lg font-medium text-white bg-white/20 backdrop-blur-sm rounded-lg hover:bg-white/30 transition border border-white/30">
          Browse Content
        </a>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li><a wire:navigate href="{{ route('app.posts') }}" class="hover:text-white transition">Blog</a></li>
