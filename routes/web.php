...
$response = PostWriter::make()
    ->prompt('একটি বিস্তারিত এবং আকর্ষণীয় ফিটনেস/স্বাস্থ্য বিষয়ক ব্লগ পোস্ট লিখুন। "
            ...
            . "title": "আকর্ষণীয় পোস্টের শিরোনাম", "tags": "tags", "content": "মার্কডাউন ফরম্যাটে সম্পূর্ণ পোস্টের কন্টেন্ট"', provider: 'mistral');
...
$prompt = "একটি বিস্তারিত এবং আকর্ষণীয় ফিটনেস/স্বাস্থ্য বিষয়ক ব্লগ পোস্ট লিখুন। "
            ...
            // Get new response
            $response = AiServiceFactory::make('cerebras')->chat([['role' => 'user', 'content' => $prompt]], ['max_tokens' => 2000, 'temperature' => 0.7]);
